...
const SettingsView: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center">
      ...
      <h2 className="text-3xl font-serif italic text-slate-900 mb-2">System Settings</h2>
      <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] max-w-xs leading-relaxed">
        Coming Soon: Global system configuration, user permissions, and AI API key management.
      </p>
    </div>
  );
};
